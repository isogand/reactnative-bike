...
const Configuration = () => {
  return (
    <ScrollView>
      <Box padding="m">
        <Text variant="body3">What type of outfits do you usually wear?</Text>
        <CheckboxGroup options={outfitTypes} radio />

        <Text variant="body3">What is your clothing size?</Text>
        <RoundCheckboxGroup options={sizes}/>

        <Text variant="body3">My preferred clothing colors</Text>
        <RoundCheckboxGroup options={colors} valueIsColor />

        <Text variant="body3">My preferred brands</Text>
